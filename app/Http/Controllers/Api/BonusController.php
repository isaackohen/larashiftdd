...
class BonusController
{
    ...
    public function rakeback(Request $request) 
    {
        ...
        if(auth('sanctum')->user()->vipLevel() == 0) return APIResponse::reject(1, 'You need to be VIP level 1 atleast to use rakeback.');
        if($stats->current_rakeback < 0.25) return APIResponse::reject(2, 'You need to have minimum of 0.25$ before claiming rakeback.');
