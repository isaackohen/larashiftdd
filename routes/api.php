...
Route::any('/external/dkapi/balance', 'ExternalController@methodBalance');
Route::any('/external/dkapi/bet', 'ExternalController@methodBet');
...
Route::middleware('auth:sanctum')->prefix('promocode')->group(function () {
    ...
    Route::post('rakeback', 'BonusController@rakeback');
    Route::any('getRakeback', 'BonusController@getRakeback');
