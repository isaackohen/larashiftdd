...
Route::get('wallet/withdrawals', 'WalletController@withdrawals');
Route::get('wallet/deposits', 'WalletController@deposits');
Route::get('users/get', 'UserController@users');
Route::get('user/games/{id}', 'UserController@games');
Route::get('user/transactions/{id}', 'UserController@transactions');
...
Route::post('maintenance', 'MainController@maintenance'); 
...
Route::prefix('telegram')->group(function() {
	Route::post('settings', 'SettingsController@telegramSettings');
});
...
Route::prefix('vips')->group(function() {
	Route::post('get', 'VipsController@get');
	Route::post('remove', 'VipsController@remove');
	Route::post('vip', 'VipsController@vip');
	Route::post('change', 'VipsController@change');
	Route::post('save', 'VipsController@save');
});